...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('build/assets/assets_palette/img_L_palette/alpha_l_circle_icon_138961.ico')}}" rel="icon">
  ...
  <main id="main">
          ...
          <div class="container">
            <div class="row justify-content-between gy-5">
              ...
              <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                <img src="assets/img_L_palette/L_palette.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        ...
        <section id="collares" class="about">
            ...
            <div class="display_flex">
              <div class="contendor_img">
                <img class="img_l" src="assets/img_L_palette/collar_1.jpg" alt="collar_1">
                <p class="parrafo_img"><strong>Collar de concha</strong></p>
                <p>Precio:180</p>
              </div>
              <div class="contendor_img">
                <img class="img_l" src="assets/img_L_palette/collar_2.jpg" alt="collar_2">
                <p class="parrafo_img"><strong>Collar mariposa</strong></p>
                <p>Precio:180</p>
              </div>
              <div class="contendor_img">
                <img class="img_l" src="assets/img_L_palette/collar_4.jpg" alt="collar_4">
                <p class="parrafo_img"><strong>Collar Corazon</strong></p>
                <p>Precio:180</p>
              </div>
            </div>
        </section>
    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        ...
        <section id="pulseras" class="about">
            <div class="section-header">
              <h2 class="titulo">Pulseras</h2>
              <p>Pulseras</p>
            </div>
            <div class="display_flex">
              <div class="contendor_img">
                <img class="img_l" src="assets/img_L_palette/pulsera_1.jpg" alt="pulsera_1">
                <p class="parrafo_img"><strong>Pulsera corazones</strong></p>
                <p>Precio:180</p>
              </div>
              <div class="contendor_img">
                <img class="img_l" src="assets/img_L_palette/pulsera_2.jpg" alt="pulsera_2">
                <p class="parrafo_img"><strong>Pulsera de panditas</strong></p>
                <p>Precio:180</p>
              </div>
              <div class="contendor_img">
                <img class="img_l" src="assets/img_L_palette/pulsera_3.jpg" alt="pulsera_3">
                <p class="parrafo_img"><strong>Pulseras de mariposas</strong></p>
                <p>Precio:180</p>
              </div>
            </div>
        </section>
